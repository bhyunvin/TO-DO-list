...
- [ ] 1. Create Zustand theme store with persistence
...
- [ ] 2. Define global CSS Custom Properties for theming
  - [ ] 2.1 Create light theme CSS variables in `client/src/index.css`
  ...
  - [ ] 2.2 Create dark theme CSS variables with `[data-theme='dark']` selector
  ...
  - [ ] 2.3 Add reduced motion support
...
- [ ] 3. Create ThemeToggle component
  - [ ] 3.1 Implement ThemeToggle component with React Bootstrap switch
...
- [ ] 4. Initialize theme in App component
...
- [ ] 5. Integrate ThemeToggle into profile dropdown
...
- [ ] 6. Refactor TodoList.css to use CSS variables
  - [ ] 6.1 Replace hardcoded colors with CSS variable references
  ...
  - [ ] 6.2 Update hover and focus states
...
- [ ] 7. Refactor LoginForm.css to use CSS variables
...
- [ ] 8. Refactor ChatModal.css to use CSS variables
...
- [ ] 9. Add Bootstrap component overrides for dark theme
  - [ ] 9.1 Create dark theme overrides in `client/src/App.css`
  ...
  - [ ] 9.2 Test all Bootstrap components in dark theme
...
- [ ] 10. Update remaining component styles
  ...
  - [ ] 10.4 Update FileUploadProgress styles
...
- [ ] 11. Verify theme consistency across all pages
...
- [ ] 12. Verify theme persistence functionality
...
- [ ] 14. Write unit tests for theme store
...
- [ ] 15. Write unit tests for ThemeToggle component
