...
function LoginForm() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.user) {
                    ...
                    // 로그인 실패
                    Swal.fire('로그인 실패', data.message || '다시 시도해 주세요.', 'error');
                }
            } else {
                // 비정상 응답 처리
    ...
    //기본은 loginForm
    let resultComponent =   <div className="login-container">
                                <h2>TO-DO</h2>
                                <form onSubmit={submitLogin}>
                                    <div className="form-group">
                                        <label htmlFor="inputID" className="mb-1">ID</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="inputPassword" className="mb-1">비밀번호</label>
                                        <input
                                            type="password"
                                            className="form-control mb-3"
                                            id="inputPassword"
    ...
    switch ( authMode ) {
        case 'login': break;
        case 'signup': resultComponent = <SignupForm onSignupComplete={handleSignupComplete} />; break;
        default: break;
    }
