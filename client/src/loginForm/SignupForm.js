        ...
        <div className="signup-container">
            ...
            <form onSubmit={submitSignupHandler}>
                ...
                <div className="form-group row mb-3">
                    <label htmlFor="userId" className="col-3 col-form-label">ID <span className="text-danger">*</span></label>
                    <div className="col-9">
                        <div className="input-group">
                            <input
                                ...
                                spellCheck="false"
                            />
                            <button type="button" className="btn btn-secondary" onClick={checkIdDuplicated}>중복체크</button>
                        </div>
                        <small className="text-danger">{idError}</small>
                        <small className={isIdDuplicated ? 'text-danger' : ''}>{idDuplicatedResult}</small>
                    </div>
                </div>

                {/* 비밀번호 */}
                <div className="form-group row mb-3">
                    <label htmlFor="userPassword" className="col-3 col-form-label">비밀번호 <span className="text-danger">*</span></label>
                    <div className="col-9">
                        <input
                            type="password"
                            className="form-control"
                ...
                {/* 비밀번호 확인 */}
                <div className="form-group row mb-3">
                    <label htmlFor="confirmUserPassword" className="col-3 col-form-label">비밀번호 확인 <span className="text-danger">*</span></label>
                    <div className="col-9">
                        <input
                            type="password"
                            className="form-control"
                ...
                {/* 이름 */}
                <div className="form-group row mb-3">
                    <label htmlFor="userId" className="col-3 col-form-label">이름 <span className="text-danger">*</span></label>
                    <div className="col-9">
                        <div className="input-group">
                            <input
                                type="text"
                ...
                {/* 이메일 */}
                <div className="form-group row mb-3">
                    <label htmlFor="userEmail" className="col-3 col-form-label">이메일 <span className="text-danger">*</span></label>
                    <div className="col-9">
                        <input
                            type="email"
                            className="form-control"
                ...
                {/* 프로필 이미지 업로드 */}
                <div className="form-group row mb-3">
                    <label htmlFor="profileImage" className="col-3 col-form-label">프로필 이미지</label>
                    <div className="col-9">
                        <input
                            type="file"
                            className="form-control"
                ...
                {/* 추가 설명 */}
                <div className="form-group row mb-3">
                    <label htmlFor="userDescription" className="col-3 col-form-label">추가 설명</label>
                    <div className="col-9">
                        <textarea
                            className="form-control"
                            id="userDescription"
